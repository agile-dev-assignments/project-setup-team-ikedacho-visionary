        ...
        <div className='FriendProfile'>
            ...
            <section>
                <section className='main-content4'>
                    {post_data.map((item) => (
                        <PostContent key={item.id} source={item.source} userimg={friend_info.user_photo} UserName={friend_info.user_name} content={item.content} Senttime={item.senttime} contentimg={item.contentimg} />
                    ))}
                </section>
            </section>
        </div>
