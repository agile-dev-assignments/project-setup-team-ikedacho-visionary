...
const MyProfile = (props) => {
  ...
  */
    const handleClick=(e)=>{//e is the id of the element clicked
        ...
        */
        //only allow one selection. select one platform, then only show post from that platform. 
        if (platform_name_array.includes(e)){
            platform_name_array = platform_name_array.filter(element=> element!==e)
            console.log(`array after delete ${e}:`,platform_name_array)
        }
    ...
    return (
        <div className = "MyProfile">
            ...
            <div  id="main_container3">
                ...
                <div class='icon' id='select_all' onClick={e=> { handleClick(e.target.id) }} >  {/* target is the element clicked */}
                    <span id='select_all_text' >All</span>
            
                </div>

                <div class='icon' id='facebook' onClick={e=> { handleClick(e.target.id) }} >  {/* target is the element clicked */}
                ...
                <div class='icon' id='twitter' onClick={e=> {handleClick(e.target.id)}} >
