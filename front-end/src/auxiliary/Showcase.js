...
const Showcase = (props) => {
    ...
    return (
        <>
            ...
            <NameTag UserName='Helen' img='https://cdn.icon-icons.com/icons2/1368/PNG/512/-avatar_89781.png' bio='A passionate evening brings both pleasure and pain. ' action='Following' />
        </>
    )
}
