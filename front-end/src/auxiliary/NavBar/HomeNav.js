...
const HomeNav = (props) => {
    ...
    return (
        <nav className='homenav'>
                ...
                <div className='post-checkbox' style={{ display: show ? 'block' : 'none' }}>
                    ...
                    >
                        <label id='platform_label'>
                            <input id='platform_label1' name='selected_social_media' value='All' type='checkbox' />
                            <p>All</p>
                        </label>

                        <label id='platform_label'>
                            <input id='platform_label2' name='selected_social_media' value='O-Zone' type='checkbox' />
                            <p>O-Zone</p>
                        </label>
                        <label id='platform_label'>
                            <input id='platform_label3' name='selected_social_media' value='Facebook' type='checkbox' />
                            <p>Facebook</p>
                        </label>
                        <label id='platform_label'>
                            <input id='platform_label4' name='selected_social_media' value='Twitter' type='checkbox' />
                            <p>Twitter</p>
                        </label>
                        <label id='platform_label'>
                            <input id='platform_label5' name='selected_social_media' value='Instagram' type='checkbox' />
                            <p>Instagram</p>
                        </label>
            ...
            <NavLink id='homenav_button' to='/recent'>
                Recently Visited
            </NavLink>
            <NavLink id='homenav_button' to='/recommend'>
                Recommend
            </NavLink>
