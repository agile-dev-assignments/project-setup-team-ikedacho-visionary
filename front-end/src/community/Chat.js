    ...
    return (
        <div className='Chat'>
            <div className='Chat_title'>
                <Link onClick={() => goTOPreviousPath()} id='back'>
                    Back
                </Link>
                <h2>Chat</h2>
            </div>
            ...
            <div className='Chat_messages'>
                {data.map((item) => (
                    <ChatMessages key={item.id} userimg={item.userimg} username={item.username} time={item.time} content={item.content} />
                ))}
            </div>

            <div className='Chat_user_input'>
                <form>
                    <input className='Chat_user_input' type='text' placeholder='Something to say...' value={newMessage} onChange={(e) => setNewMessage(e.target.value)} />
                    <button className='Chat_user_input' type='submit' onClick={submitMessage}>
                        Enter
                    </button>
                </form>
            </div>
